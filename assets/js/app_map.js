...
} // End of Option CHanged Function

function UpdateMapData(country){

  d3.csv("Data/CountryKeyData.csv").then((C) => {
  ...
  { 
      ...
      for (var i = 0; i < filteredCountry.length ; i++){
          Longtitude.push(KeyData[i].Long);
          console.log(KeyData[i].Long);
         }
      ...
      for (var i = 0; i < filteredCountry.length ; i++){
          Latitude.push(KeyData[i].Lat);
          console.log(KeyData[i].Lat);
         }
      ...
      for (var i = 0; i < filteredCountry.length ; i++){
         c_name_key.push(KeyData[i].Country_Name);
          console.log(KeyData[i].Country_Name);
         }
    
      console.log(c_name_key);

      var city_name_key = [];

      for (var i = 0; i < filteredCountry.length ; i++){
          city_name_key.push(KeyData[i].City);
          console.log(KeyData[i].City);
         }
    
      console.log(city_name_key);

      UpdateMap(Latitude, Longtitude);
...
function UpdateMap(Latitude, Longtitude) {
    ...
    map.setView(new L.LatLng(Latitude, Longtitude), 5);
